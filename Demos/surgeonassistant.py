...
def getTool(angle1, angle2):
    ...
    time.sleep(3)
    arm.setPosition([[1,240],[2, 515],[3,840],[4,280],[5,630],[6,angle1]])
    time.sleep(3)
    arm.setPosition([[1,550],[2, 515],[3,840],[4,280],[5,630],[6,angle1]])
    time.sleep(3)
    arm.setPosition([[1,550],[2, 515],[3, 840],[4,425],[5,335],[6,angle2]])
    time.sleep(2)
    arm.setPosition([[1,550],[2, 515],[3, 840],[4,425],[5,335],[6,angle2]])
    time.sleep(3)
    arm.setPosition([[1,550],[2, 515],[3, 195],[4,425],[5,335],[6,surgeon_angle]])
    time.sleep(2)
...
def cleanTool(angle1, angle2):
    ...
    arm.setPosition([[1,500],[2, 515],[3, 195],[4,425],[5,335],[6,surgeon_angle]]) #idle arm position
    time.sleep(2)
